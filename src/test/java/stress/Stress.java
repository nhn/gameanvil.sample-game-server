...
import stress._handler.CallbackAuthenticationRes;
import stress._handler.CallbackCreateRoomRes;
import stress._handler.CallbackLeaveRoomRes;
import stress._handler.CallbackLoginRes;
import stress._handler.CallbackLogout;
import stress._handler.CallbackShuffleDeckRes;
import stress._handler.SampleTimeout;
...
//        Config.addRemoteInfo("10.77.35.47", 11200);
        ...
        // 컨텐츠 서비스 등록.
        connector.addService(0, GameConstants.GAME_NAME);
