package com.nhn.gameflex.sample.game.user;

import co.paralleluniverse.fibers.SuspendExecution;
import com.nhn.gameflex.sample.game.user._handler._ShuffleDeckReq;
import com.nhn.gameflex.sample.mybatis.UserDbHelperService;
import com.nhn.gameflex.sample.game.GameNode;
import com.nhn.gameflex.sample.game.user._handler._ChangeNicknameReq;
import com.nhn.gameflex.sample.game.user._handler._SingleScoreRankingReq;
import com.nhn.gameflex.sample.game.user.model.GameUserInfo;
import com.nhn.gameflex.sample.game.user.model.GameUserTransferInfo;
import com.nhn.gameflex.sample.protocol.Authentication;
import com.nhn.gameflex.sample.protocol.GameMulti;
import com.nhn.gameflex.sample.protocol.GameMulti.RoomUserData;
            ...
            try {
                ...
                if (loginReq == null || loginReq.getUuid().isEmpty()) {
                    ...
                    if (dbGameUserInfo == null) {   // DB에 데이터가 없으므로 신규
                        // 게임 데이터 설정
                        gameUserInfo.setNickname("Gameflex-" + getUserId());
