package com.nhn.gameflex.sample.support._handler.rest;

import co.paralleluniverse.fibers.SuspendExecution;
import com.google.gson.JsonObject;
import com.nhn.gameflex.GameflexUtil;
import com.nhn.gameflex.packet.RestPacketHandler;
...
//        restObject.setResponseStatus(HttpResponseStatus.BAD_REQUEST);
        ...
        // 결과 응답
        restObject.writeString(GameflexUtil.Gson().toJson(jsonObject));   // gameplex에서 제공하는 Gson사용
    }
}
