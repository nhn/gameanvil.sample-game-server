 ...
 */
public class _SnakeUserMsg implements RoomMessageHandler<SnakeRoom, GameUser, GameMulti.SnakeUserMsg > {
    private static final Logger logger = getLogger(_SnakeUserMsg.class);

    @Override
    public void execute(SnakeRoom room, GameUser user, GameMulti.SnakeUserMsg snakeUserMsg) throws SuspendExecution {
